...
function HomePage() {
    return (
        <>
            <div className="home">
                <span className="home__title">Your Notes</span>
                <div className="home__option">
                    <ul className="home__option-list">
                        <li>
                            <NavLink to={"/all-notes"} className="home__nav-link home__nav-link--active">
                                All
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to={"/shared-notes"} className="home__nav-link">
                                Shared Notes
                            </NavLink>

                        </li>
                        <li>
                            <NavLink to={"/pin-notes"} className="home__nav-link">
                                Shared Notes
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to={"/favorite-notes"} className="home__nav-link">
                                Shared Notes
                            </NavLink>
                        </li>
                    </ul>
